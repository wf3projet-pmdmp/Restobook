            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <ul class="nav navbar-right top-nav">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu message-dropdown">
                            ...
                            <li class="message-footer">
                                <a href="<?= $this->url('admin_listcontact') ?>">Read All New Messages</a>
                            </li>
                        </ul>
                    </li>
                    <li class="dropdown">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a href="<?= $this->url('admin_listcontact') ?>"><i class="fa fa-fw fa-envelope"></i> Inbox</a>
                            </li>
                            <li>
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav side-nav">
                        <li class="active">
                            <a href="<?= $this->url('admin_home') ?>"><i class="fa fa-fw fa-dashboard"></i> Panneau D'Administration</a>
                        </li>
                        <li>
                            <a href="<?= $this->url('admin_listusers') ?>"><i class="fa fa-fw fa-user"></i> Utilisateurs</a>
                        </li>
                        <li>
                            <a href="<?= $this->url('admin_listresto') ?>"><i class="fa fa-fw fa-cutlery"></i> Restaurants</a>
                        </li>
                        <li>
                            <a href="<?= $this->url('admin_listreserv') ?>"><i class="fa fa-fw fa-ticket"></i> Réservations</a>
                        </li>
                        <li>
